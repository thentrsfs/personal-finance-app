<template>
  <q-dialog v-model="potsStore.addPotDialog">
    <q-card
    ...
    >
      ...
      <q-card-section>
        ...
        <q-input
          ...
          counter
          v-model="potsStore.newPot.label"
          maxlength="30"
          dense
          outlined
        ></q-input>
      ...
      <q-card-section class="q-py-xs">
        ...
        <q-input
          for="target"
          v-model.number="potsStore.newPot.target"
          @keyup.enter="potsStore.addNewPot"
